...
async def create_todo_item(
    todo: SchemasTodoItemCreate, db: AsyncSession = Depends(get_db)
) -> SchemasTodoItem:
...
async def update_todo_item(
    todo_id: int, todo: SchemasTodoItemUpdate, db: AsyncSession = Depends(get_db)
):
